            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="font-fraunces text-2xl font-bold text-forest">Create New Blog</h1>
                            <p className="text-stone text-sm mt-1">Write engaging content with HTML formatting</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className={`${previewMode ? 'lg:col-span-2' : 'lg:col-span-3'} transition-all duration-300`}>
                        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-sage-15 overflow-hidden">
                            {/* Title Field */}
