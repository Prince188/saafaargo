            ...
            <div className="content-wrapper">
                ...
                <header className="heros">
                    <div className="profile-photo-container">
                        <img src={user.profilePic} alt={user.firstName} className="hero-img" />
                    </div>
                    ...
                    <div className="verify-grid">
                        <div className="verify-card">
                            ...
                            <div className="add-btn">
                                <FaPlus size={16} color="var(--primary-green)" />
                            </div>
                        </div>
                        <div className="verify-card">
                            <div className="v-card-top">
                            ...
                            {vehicles.map((v, index) => (
                                ...
                                >
                                    <div className="v-img-box">
                                        <FaCarAlt size={28} color="white" />
                                    </div>
                                    <div className="v-details">
                                        <p className="v-brand">{v.brand?.toUpperCase()}</p>
                                        <p className="v-model">{v.model}</p>
